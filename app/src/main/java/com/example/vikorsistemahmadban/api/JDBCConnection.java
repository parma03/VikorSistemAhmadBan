...
public class JDBCConnection {
    ...
    private static final String EMULATOR_HOST = "10.0.2.2"; // untuk emulator Android
    private static final String REAL_DEVICE_HOST  = "192.168.18.191"; // untuk emulator Android
